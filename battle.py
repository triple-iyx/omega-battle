...
async def update_data(users, user):
	...
	embed.add_field(name='Weapons:', value='**{}**: {}, **gold**\n**{}**: {}, **gold**\n**{}**: {}, **gold**\n**{}**: {}, **gold**'.format(rweapons[w], rvalue[w], rweapons[x], rvalue[x], rweapons[y], rvalue[y], rweapons[z], rvalue[z]))
	await client.say(embed=embed)
	...
	if user.id in users:
		...
		if enemyhp <= 0:
			...
			if lvl_start < lvl_end:
				await client.say('**{}** has leveled up to level **{}**!'.format(lvl_end))
